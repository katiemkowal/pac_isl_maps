...
mview_probabilistic(fmodel.isel(time=0), title='GEFS, Week-34, S. Weighted Cons., Valid: 13Jun2024 - 26Jun2024', savefig=os.path.join(cfg.output_path,'gefs_week_34_cons.png'))

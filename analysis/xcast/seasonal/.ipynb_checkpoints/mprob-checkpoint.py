...
bounds = [35,40,45,50,55,60,65,70,75,80]
nbounds = [35,40,45,50]
...
def mview_probabilistic(X, x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None, title='', coastlines=False, borders=True, ocean=True, label=None, label_loc=(0.01, 0.98), savefig=None, drymask=None):
    ...
    fig, ax = plt.subplots(nrows=1, ncols=1, figsize=(7, 9), subplot_kw={'projection': ccrs.PlateCarree(central_longitude=180)})
    ...
    if borders is True:
        ...
        for country in countries:
            ax.add_geometries([country.geometry],ccrs.PlateCarree(central_longitude=180),facecolor='none',edgecolor='black',lw=0.75)
    elif borders:

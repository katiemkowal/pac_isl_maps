...
model = modelt.sel(lon=slice(cfg.large_predictand_zone['west'], 
                             cfg.large_predictand_zone['east']),
                   lat=slice(cfg.large_predictand_zone['south'],
                             cfg.large_predictand_zone['north']))
fmodel = fmodelt.sel(lon=slice(cfg.large_predictand_zone['west'], 
                             cfg.large_predictand_zone['east']),
                   lat=slice(cfg.large_predictand_zone['south'],
                             cfg.large_predictand_zone['north']))
obs = obs.sel(lon=slice(cfg.final_predictand_zone['west'], 
                             cfg.final_predictand_zone['east']),
                   lat=slice(cfg.final_predictand_zone['south'],
                             cfg.final_predictand_zone['north']))
...
model = modelt.sel(lon=slice(cfg.final_predictand_zone['west'], 
                             cfg.final_predictand_zone['east']),
                   lat=slice(cfg.final_predictand_zone['south'],
                             cfg.final_predictand_zone['north']))
fmodel = fmodelt.sel(lon=slice(cfg.final_predictand_zone['west'], 
                             cfg.final_predictand_zone['east']),
                   lat=slice(cfg.final_predictand_zone['south'],
                             cfg.final_predictand_zone['north']))
obs = obs.sel(lon=slice(cfg.final_predictand_zone['west'], 
...
fr = fr.rename({'M' : 'e'})
#tt = fr.to_dataset(name =  'prob')
#tt.to_netcdf(os.path.join(cfg.tmp_path,'temp_elr.nc'))

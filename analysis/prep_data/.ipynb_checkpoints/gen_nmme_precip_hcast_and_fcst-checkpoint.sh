...
rm nmme_hind_precip_ld_${ld}.dat
...
'close 1'
'open /cpc/int_desk/NMME/hindcast/raw_sst_precip_tmp2m/precip_monthly/${mon}ic_ENSM_MEAN_1991-2022.ctl'
'set lat -90 90'
'set lon -180 180'
zz = ${ld} + 1 
'set gxout fwrite'
'set fwrite nmme_hind_precip_ld_${ld}.dat'
i=1
while(i<=32)
'set t 'i
...
rm nmme_fcst_precip_ld_${ld}.dat
...
zz = ${ld} + 1
'set gxout fwrite'
'set fwrite nmme_fcst_precip_ld_${ld}.dat'
...
f1 = "nmme_hind_precip_ld_${ld}.dat"
...
nlon = np.arange(lonw,lone+res1,res1); nx = 360;
...
ncfile = netCDF4.Dataset('nmme_hind_precip_ld${ld}.nc',mode='w',format='NETCDF4_CLASSIC')
...
f2 = "nmme_fcst_precip_ld_${ld}.dat"
...
mv *.nc /cpc/int_desk/pac_isl/data/processed/

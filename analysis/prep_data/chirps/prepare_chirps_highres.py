...
file_name_to_save = '_'.join(['CHIRPS',cfg.region_name + '.nc'])
#to save all seasons as one netcdf file, uncomment the line below
...
#     file_name_to_save = '_'.join([s, 'UCSB0p05', cfg.region_name + '.nc'])

...
#ONLY USE THIS GRADS IF NOT USING PPERL 
#PPERL IS NEEDED IF USING THE REGRID FUNCTION
...
######### NOTE RAN REGRID FUNCTION TO FIX GRID IN PRINTED PLOTS
...
#THIS COMMAND BELOW, WAS ADDED TO REGRID DATA#

...
f2 = "/cpc/int_desk/pac_isl/data/processed/nmme/dat_files/nmme_oneseas_fcst_precip_ld_3.dat"
...
ncfile = netCDF4.Dataset('nmme_oneseas_fcst_precip_ld3.nc',mode='w',format='NETCDF4_CLASSIC')

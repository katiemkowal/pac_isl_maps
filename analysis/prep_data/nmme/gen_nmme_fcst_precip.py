...
ncfile = netCDF4.Dataset('Jan_ld3_NMME_fcst_precip.nc',mode='w',format='NETCDF4_CLASSIC')
...
time.axis = 'T'
times = [datetime.datetime(2024,1,1) + relativedelta(years=x) for x in range(0,nt)]

...
f1 = "/cpc/int_desk/pac_isl/data/processed/nmme/dat_files/nmmec_hind_precip_ld_3.dat"
...
ncfile = netCDF4.Dataset('/cpc/int_desk/pac_isl/data/processed/nmme/nc_files/nmmec_hind_precip_ld3.nc',mode='w',format='NETCDF4_CLASSIC')
...
units = 'days since 2024-06-07'
calendar = 'proleptic_gregorian'
time = ncfile.createVariable('time', np.float64, ('time',))
time.long_name = 'time'
time.units = 'days since 2024-06-07 00:00:00'
time.calendar = 'proleptic_gregorian'
time.axis = 'T'
times = [datetime.datetime(2024, 6, 7) + relativedelta(years=x) for x in range(0,nt)]

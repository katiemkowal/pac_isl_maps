...
f2 = "/cpc/int_desk/pac_isl/data/processed/nmme/dat_files/nmme_threeseas_fcst_sst_ld_3.dat"
...
ncfile = netCDF4.Dataset('Jun_ld3_three_seas_NMME_fcst_sst.nc',mode='w',format='NETCDF4_CLASSIC')

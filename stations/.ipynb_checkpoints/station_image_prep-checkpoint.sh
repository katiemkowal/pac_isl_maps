...
main(){
    ...
    gdal2tiles.py -p mercator -z 0-5 /cpc/int_desk/pac_isl/stations/images/station_data/gefswk1pcons.tif /cpc/int_desk/pac_isl/stations/images/gefswk1pcons_tiles

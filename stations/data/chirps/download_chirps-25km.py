...
def download_CHIRPS(URL, FIRSTYEAR, LASTYEAR):
    ...
    for y in YEARS:
        ...
        target_file = "chirps-v2.0." + y + ".days_p25.nc"
        print(target_file)
...
#to update existing files uncomment the following line to remove before redownloading
#os.remove("chirps-v2.0." + str(current_year) + ".days_p25.nc")
